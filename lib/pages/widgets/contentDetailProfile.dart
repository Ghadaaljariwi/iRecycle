...
class ContentDetailProfile extends StatefulWidget {
  final DocumentSnapshot postData;
  ContentDetailProfile({
    required this.postData,
  });
  @override
  State<StatefulWidget> createState() => _ContentDetailProfile();
}

class _ContentDetailProfile extends State<ContentDetailProfile> {
